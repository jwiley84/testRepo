...
using ghIssueTestBot.Models;
using ghIssueTestBot.Responses.Cancel;
using ghIssueTestBot.Responses.Main;
using ghIssueTestBot.Services;

namespace ghIssueTestBot.Dialogs
{
    public class MainDialog : RouterDialog
    {
        ...
        protected override async Task<InterruptionAction> OnInterruptDialogAsync(DialogContext dc, CancellationToken cancellationToken)
        {
            if (dc.Context.Activity.Type == ActivityTypes.Message && !string.IsNullOrWhiteSpace(dc.Context.Activity.Text))
            {
                ...
                if (luisService == null)
                {
                    throw new Exception("The general LUIS Model could not be found in your Bot Services configuration. I made another small change.");
                }
                else
                {
